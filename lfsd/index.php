            ...
            <div class="content-wrapper">
                <div class="container">
                    <div class="row pad-botm">
                        <div class="col-md-12">
                            <h4 class="header-line">SISTEMA DE GESTIÓN DEL DPTO. MÉDICO DE LOS SANTOS.</h4>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    ';
    include("config.php");
    $reponse = $bdd->query('SELECT * FROM ems');
