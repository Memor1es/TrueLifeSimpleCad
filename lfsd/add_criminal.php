<html>
	<head>
		...
		<meta name="author" content="" />
			<title>LFSD ~ AÑADIR REGISTRO</title>
				...
				<div class="panel-body">
					<form action="add_criminal_post.php" method="post">
						<p>
							...
							<div class="form-group">
								<label for="message">REGISTRO</label> :
								<p class="help-block">EJEMPLO: OPERACIÓN / TRATAMIENTO...</p>
								<input type="text" name="registromedico" id="registromedico" class="form-control"/>
								<br />
							</div>
							<div class="form-group">
								<label for="message">SEGURO U COSTO</label> :
								<p class="help-block">EJEMPLO: CUBIERTO POR SEGURO / COSTO ADICIONAL DE: 9000$</p>
