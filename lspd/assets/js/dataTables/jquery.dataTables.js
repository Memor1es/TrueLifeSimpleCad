...
(/** @lends <global> */function( $ ) {
	...
	function _fnLanguageCompat( oLanguage )
	{
		...
		if ( !oLanguage.sEmptyTable && zeroRecords &&
			oDefaults.sEmptyTable === "Nada por aquí... ¿Seguro que estás haciendo bien tu trabajo?" )
		{
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "emptyTable": "Nada por aquí... ¿Seguro que estás haciendo bien tu trabajo?"
			 *        }
			 *      } );
			 *    } );
			 */
			"sEmptyTable": "Nada por aquí... ¿Seguro que estás haciendo bien tu trabajo?",
